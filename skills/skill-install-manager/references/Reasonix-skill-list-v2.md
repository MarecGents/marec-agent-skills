...
自动检查下方列出的所有 Skill 是否已安装。每个 Origin URL 下可能包含一个或多个 Skill。若发现尚未安装的 Skill，请自动从该 Skill 所属的 Origin URL 下载并安装同名的 Skill。

**安装要求：** 下载完成后，先验证该 Skill 是否能与你的调用规则完美适配。若存在不适配的情况，可进行适当修改，但不得改动 Skill 的核心功能。安装时，请将其安装为全局 Skill。

## Origin URL: https://github.com/MarecGents/marec-agent-skills

Skill Name and install command

1. check-reasonix-update: npx skills add https://github.com/MarecGents/marec-agent-skills --skill check-reasonix-update
2. default: npx skills add https://github.com/MarecGents/marec-agent-skills --skill default
3. douyin-downloader: npx skills add https://github.com/MarecGents/marec-agent-skills --skill douyin-downloader
...
2. frontend-design: npx skills add https://github.com/anthropics/skills --skill frontend-design
3. pdf: npx skills add https://github.com/anthropics/skills --skill pdf
4. pptx: npx skills add https://github.com/anthropics/skills --skill pptx
...
1. agent-browser: npx skills add https://github.com/vercel-labs/agent-browser --skill agent-browser

## Origin URL: https://github.com/anthropics/skills

Skill Name and install command

1. skill-creator: npx skills add https://github.com/anthropics/skills --skill skill-creator

## Origin URL: https://github.com/julianobarbosa/claude-code-skills

Skill Name and install command

1. markitdown: npx skills add https://github.com/julianobarbosa/claude-code-skills --skill markitdown
...
2. academic-paper-reviewer: npx skills add https://github.com/imbad0202/academic-research-skills --skill academic-paper-reviewer
3. deep-research: npx skills add https://github.com/imbad0202/academic-research-skills --skill deep-research
4. academic-pipeline: npx skills add https://github.com/imbad0202/academic-research-skills --skill academic-pipeline

## Origin URL: https://github.com/Yuan1z0825/nature-skills

Skill Name and install command

0. _shared
1. nature-academic-search: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-academic-search
2. nature-citation: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-citation
3. nature-data: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-data
4. nature-figure: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-figure
5. nature-paper-to-patent: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-paper-to-patent
6. nature-paper2ppt: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-paper2ppt
7. nature-polishing: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-polishing
8. nature-reader: npx skills add https://github.com/yuan1z0825/nature-skills --skill nature-reader
...
## Origin URL: https://github.com/leonardomso/rust-skills

Skill Name and install command

1. rust-skills: npx skills add https://github.com/leonardomso/rust-skills --skill rust-skills

## Origin URL: https://github.com/samber/cc-skills-golang

Skill Name and install command

1. golang-code-style: npx skills add https://github.com/samber/cc-skills-golang --skill golang-code-style
2. golang-documentation: npx skills add https://github.com/samber/cc-skills-golang --skill golang-documentation
3. golang-error-handling: npx skills add https://github.com/samber/cc-skills-golang --skill golang-error-handling
4. golang-lint: npx skills add https://github.com/samber/cc-skills-golang --skill golang-lint
5. golang-naming: npx skills add https://github.com/samber/cc-skills-golang --skill golang-naming
6. golang-safety: npx skills add https://github.com/samber/cc-skills-golang --skill golang-safety
7. golang-security: npx skills add https://github.com/samber/cc-skills-golang --skill golang-security
8. golang-structs-interfaces: npx skills add https://github.com/samber/cc-skills-golang --skill golang-structs-interfaces
9. golang-concurrency: npx skills add https://github.com/samber/cc-skills-golang --skill golang-concurrency
10. golang-context: npx skills add https://github.com/samber/cc-skills-golang --skill golang-context
11. golang-data-structures: npx skills add https://github.com/samber/cc-skills-golang --skill golang-data-structures
12. golang-database: npx skills add https://github.com/samber/cc-skills-golang --skill golang-database
13. golang-dependency-injection: npx skills add https://github.com/samber/cc-skills-golang --skill golang-dependency-injection
14. golang-design-patterns: npx skills add https://github.com/samber/cc-skills-golang --skill golang-design-patterns
15. golang-modernize: npx skills add https://github.com/samber/cc-skills-golang --skill golang-modernize
16. golang-refactoring: npx skills add https://github.com/samber/cc-skills-golang --skill golang-refactoring
17. golang-benchmark: npx skills add https://github.com/samber/cc-skills-golang --skill golang-benchmark
18. golang-observability: npx skills add https://github.com/samber/cc-skills-golang --skill golang-observability
19. golang-performance: npx skills add https://github.com/samber/cc-skills-golang --skill golang-performance
20. golang-testing: npx skills add https://github.com/samber/cc-skills-golang --skill golang-testing
21. golang-troubleshooting: npx skills add https://github.com/samber/cc-skills-golang --skill golang-troubleshooting
22. golang-cli: npx skills add https://github.com/samber/cc-skills-golang --skill golang-cli
23. golang-continuous-integration: npx skills add https://github.com/samber/cc-skills-golang --skill golang-continuous-integration
24. golang-dependency-management: npx skills add https://github.com/samber/cc-skills-golang --skill golang-dependency-management
25. golang-gopls: npx skills add https://github.com/samber/cc-skills-golang --skill golang-gopls
26. golang-pkg-go-dev: npx skills add https://github.com/samber/cc-skills-golang --skill golang-pkg-go-dev
27. golang-popular-libraries: npx skills add https://github.com/samber/cc-skills-golang --skill golang-popular-libraries
28. golang-project-layout: npx skills add https://github.com/samber/cc-skills-golang --skill golang-project-layout
29. golang-stay-updated: npx skills add https://github.com/samber/cc-skills-golang --skill golang-stay-updated
30. golang-how-to: npx skills add https://github.com/samber/cc-skills-golang --skill golang-how-to
31. golang-graphql: npx skills add https://github.com/samber/cc-skills-golang --skill golang-graphql
32. golang-grpc: npx skills add https://github.com/samber/cc-skills-golang --skill golang-grpc
33. golang-swagger: npx skills add https://github.com/samber/cc-skills-golang --skill golang-swagger
34. golang-google-wire: npx skills add https://github.com/samber/cc-skills-golang --skill golang-google-wire
35. golang-uber-dig: npx skills add https://github.com/samber/cc-skills-golang --skill golang-uber-dig
36. golang-uber-fx: npx skills add https://github.com/samber/cc-skills-golang --skill golang-uber-fx
37. golang-spf13-cobra: npx skills add https://github.com/samber/cc-skills-golang --skill golang-spf13-cobra
38. golang-spf13-viper: npx skills add https://github.com/samber/cc-skills-golang --skill golang-spf13-viper
39. golang-stretchr-testify: npx skills add https://github.com/samber/cc-skills-golang --skill golang-stretchr-testify
40. golang-samber-do: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-do
41. golang-samber-hot: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-hot
42. golang-samber-lo: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-lo
43. golang-samber-mo: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-mo
44. golang-samber-oops: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-oops
45. golang-samber-ro: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-ro
46. golang-samber-slog: npx skills add https://github.com/samber/cc-skills-golang --skill golang-samber-slog

## Origin URL: https://github.com/wdm0006/python-skills
...
1. spring-explore: npx skills add https://github.com/Amplicode/spring-skills --skill spring-explore
2. spring-planning: npx skills add https://github.com/Amplicode/spring-skills --skill spring-planning
3. spring-data-jpa: npx skills add https://github.com/Amplicode/spring-skills --skill spring-data-jpa
4. spring-data-jdbc: npx skills add https://github.com/Amplicode/spring-skills --skill spring-data-jdbc
5. crud-rest-controller: npx skills add https://github.com/Amplicode/spring-skills --skill crud-rest-controller
6. dto-creator: npx skills add https://github.com/Amplicode/spring-skills --skill dto-creator
7. mapper-creator: npx skills add https://github.com/Amplicode/spring-skills --skill mapper-creator
8. spring-security-configuration: npx skills add https://github.com/Amplicode/spring-skills --skill spring-security-configuration
9. kafka-configuration: npx skills add https://github.com/Amplicode/spring-skills --skill kafka-configuration
10. connekt-script-writer: npx skills add https://github.com/Amplicode/spring-skills --skill connekt-script-writer
11. codefmt: npx skills add https://github.com/Amplicode/spring-skills --skill codefmt
12. run-tests: npx skills add https://github.com/Amplicode/spring-skills --skill run-tests
13. coverage: npx skills add https://github.com/Amplicode/spring-skills --skill coverage
14. java-debug: npx skills add https://github.com/Amplicode/spring-skills --skill java-debug
15. amplicode-install: npx skills add https://github.com/Amplicode/spring-skills --skill amplicode-install

## Origin URL: https://github.com/vercel-labs/agent-skills
...
4. react-view-transitions: npx skills add https://github.com/vercel-labs/agent-skills --skill react-view-transitions
5. react-native-skills: npx skills add https://github.com/vercel-labs/agent-skills --skill react-native-skills
6. writing-guidelines: npx skills add https://github.com/vercel-labs/agent-skills --skill writing-guidelines
7. vercel-optimize: npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-optimize
8. deploy-to-vercel: npx skills add https://github.com/vercel-labs/agent-skills --skill deploy-to-vercel
9. vercel-cli-with-tokens: npx skills add https://github.com/vercel-labs/agent-skills --skill vercel-cli-with-tokens

## Origin URL: https://github.com/sectapunterx/cpp-mentor

Skill Name and install command

1. cpp-mentor: npx skills add https://github.com/sectapunterx/cpp-mentor --skill cpp-mentor

## Origin URL: https://github.com/zhuangwenhui/CodingSkills
